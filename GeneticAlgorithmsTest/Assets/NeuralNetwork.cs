...
public class NeuralNetwork : MonoBehaviour {
    ...
    public void predict(float[] inputs,ref double steering,ref double acceleration) //Hard coded in not a good practice but will do for prototype. Matrix class will be added in the next version
    {
        double[] firstLayer =
         {
        ...
        steering = lastLayer[0];
        acceleration = lastLayer[1];
    ...
    public void save()
    {
        StreamWriter write = new StreamWriter("./NeuralNetwork.txt", true);
        string Data = "";
        for (int i = 0; i < 6; i++)
